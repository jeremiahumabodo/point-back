...
export type SettingsFields = {
  ...
  token: string;
  saving: boolean;
  onChange: (field: "address" | "token", value: string) => void;
};
      ...
      <form className="pb-settings-form" onSubmit={onSubmit}>
        <label className="pb-settings-field">
          ...
          <input
            ...
            onChange={
              fields
                ? (event) => fields.onChange("address", event.target.value)
                : undefined
            }
        ...
        <label className="pb-settings-field">
          ...
          <input
            ...
            onChange={
              fields
                ? (event) => fields.onChange("token", event.target.value)
                : undefined
            }
            disabled={fields?.saving}
            type="password"
