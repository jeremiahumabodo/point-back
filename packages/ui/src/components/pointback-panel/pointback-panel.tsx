...
/** Prop-driven presentation. No browser APIs, agent protocols, or DOM targeting. */
    ...
    >
      <header className="pb-header">
        ...
        <div className="pb-header-actions">
          ...
          >
            <Icon name="moon" className="pb-theme-toggle-moon" />
            <Icon name="sun" className="pb-theme-toggle-sun" />
      ...
      <div className="pb-message-scroll" hidden={pane !== "conversation"}>
        <div
